...
Гернгутеры (Moravians) строили общество с полным контролем над браками и жизнью. Франклин скептичен к такому отсутствию свободы выбора, но признает их дисциплину и музыку. Он наблюдает, анализирует, но не судит агрессивно. Это пример **толерантности натуралиста**.## ГЛАВА XII: Порядок в **Эпоху Хаоса**
